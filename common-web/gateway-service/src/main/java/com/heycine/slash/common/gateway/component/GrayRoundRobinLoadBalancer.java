package com.heycine.slash.common.gateway.component;
...
import com.heycine.slash.common.gateway.config.constant.*;
...
public class GrayRoundRobinLoadBalancer extends RoundRobinLoadBalancer {
	...
	Response<ServiceInstance> getInstanceResponse(List<ServiceInstance> instances, Request request) {
		...
		String reqVersion = headers.getFirst(GatewayConstant.VERSION);
		...
		for (ServiceInstance instance : instances) {
			...
			String targetVersion = MapUtil.getStr(metadata, GatewayConstant.VERSION);
